...
export const products: Product[] = [
    ...
    },
    {
        ...
        description:
            'O Logitech G403 Hero é equipado com o sensor HERO 25K, oferecendo precisão máxima com até 25.600 DPI ajustáveis. Design ergonômico, estrutura leve e weight ajustável, ideal para quem busca conforto e alto desempenho em jogos.',
        brand: 'Logitech',
        model: '910-005631',
    ...
    },
    {
        ...
        description:
            'O Razer Kraken X é um headset ultraleve com som surround 7.1 e almofadas em espuma com memory para máximo conforto. Microfone cardioide e estrutura reforçada para durabilidade.',
        brand: 'Razer',
    ...
    {
        id: 22,
        name: 'graphics card NVIDIA GeForce RTX 3060 Ventus 2X MSI',
        description:
    ...
    {
        id: 23,
        name: 'graphics card AMD Radeon RX 6800 XT',
        description:
    ...
    },
    {
        ...
        description:
            'A ROG Strix Z590-E é uma placa-mãe premium para processores Intel de 11ª geração, com suporte a overclock, Wi-Fi 6E integrado e iluminação RGB ASUS Aura Sync.',
        brand: 'ASUS',
    ...
    {
        id: 26,
        name: 'memory RAM Corsair Vengeance RGB Pro 16GB (2x8GB)',
        description:
    ...
    {
        id: 27,
        name: 'memory RAM Kingston Fury Beast 32GB (2x16GB)',
        description:
